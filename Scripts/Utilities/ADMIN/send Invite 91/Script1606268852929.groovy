...
for (int pos = 1; pos <= 50; pos++) {
    WebUI.waitForElementVisible(findTestObject('ADMIN/Users/btn_Invite Consumer'), 0)

	WebUI.click(findTestObject('ADMIN/Users/btn_Invite Consumer'), FailureHandling.CONTINUE_ON_FAILURE)
