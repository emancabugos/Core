...
WebUI.setText(findTestObject('SUNTEC/Users/textfield_Search'), GlobalVariable.sb_username)

WebUI.sendKeys(findTestObject('SUNTEC/Users/textfield_Search'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

WebUI.click(findTestObject('SUNTEC/Users/linktext_Login'))

WebUI.waitForElementVisible(findTestObject('SUNTEC/Users/button_Okay'), 0)

WebUI.click(findTestObject('SUNTEC/Users/button_Okay'), FailureHandling.CONTINUE_ON_FAILURE)
