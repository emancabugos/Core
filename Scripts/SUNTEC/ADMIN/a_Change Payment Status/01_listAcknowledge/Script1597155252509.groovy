...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Transaction List and Details/Transaction List Page/value_OrderStatus'), 
    'Acknowledged', false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SUNTEC/Orders List/textlabel_PaymentStatus'), 'Acknowledged', false, 0)
...
WebUI.verifyElementText(findTestObject('SUNTEC/Purchase History List - Buyer/textlabel_PaymentStatus'), 'Acknowledged')
