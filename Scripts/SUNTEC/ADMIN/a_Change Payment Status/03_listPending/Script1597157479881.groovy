...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Transaction List and Details/Transaction List Page/value_OrderStatus'), 
    'Pending', false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_OrderStatus'), 'Pending', false, 0)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SUNTEC/Orders List/textlabel_PaymentStatus'), 'Pending', false, 0)
...
WebUI.verifyElementText(findTestObject('SUNTEC/Purchase History List - Buyer/textlabel_PaymentStatus'), 'Pending')
