...
WebUI.comment('Add Parent Category')

WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category 01')

WebUI.click(findTestObject('ADMIN/Categories/Category/button_Browse'))

WebUI.delay(1)

WebUI.uploadFile(findTestObject('ADMIN/Categories/Category/image_input image'), 'C:\\Katalon\\BespokeAPI\\Images\\Category\\1.png')
...
WebUI.waitForElementNotVisible(findTestObject('ADMIN/Categories/Category/label_edit popup'), 0)
...
WebUI.comment('Add Child Category')

WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Sub Category 1.1')
...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Categories/Category/dropdown_Parent'), 'Category 01', false)
