...
WebUI.selectOptionByLabel(findTestObject('BESPOKE DEL 2/MERCHANT/Orders and Details/Order Details/OrderStatus_dropdown'), 
    'Delivered', false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SUNTEC/Orders List/dropdown_OrderStatus'), 'Delivered', false, 0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_OrderStatus'), 'Delivered')
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_OrderStatus'), 'Delivered', false, 0)
