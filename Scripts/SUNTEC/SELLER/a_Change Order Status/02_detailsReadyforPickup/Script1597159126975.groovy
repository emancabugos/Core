...
WebUI.selectOptionByLabel(findTestObject('BESPOKE DEL 2/MERCHANT/Orders and Details/Order Details/OrderStatus_dropdown'), 
...
WebUI.waitForElementVisible(findTestObject('SUNTEC/Orders List/dropdown_OrderStatus'), 0)

WebUI.verifyOptionSelectedByLabel(findTestObject('SUNTEC/Orders List/dropdown_OrderStatus'), 'Ready for pick-up', false, 
    0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_OrderStatus'), 'Ready for pick-up')
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_OrderStatus'), 'Ready for Pick-up', false, 0)
