...
WebUI.verifyTextPresent('Customize the email and html for your notifications sent to your users', false)

WebUI.click(findTestObject('ADMIN/Email Notifications/Email Template/LinkText_Edit Welcome Mail'))

WebUI.verifyTextPresent('Enable this Email Notification', false)
