...
WebUI.setText(findTestObject('ADMIN/Create New Group/textfield_Group Name'), 'User Group E')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '09Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '10Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '11Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '12Seller')
