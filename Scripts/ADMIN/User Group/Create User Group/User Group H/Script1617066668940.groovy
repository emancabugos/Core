...
WebUI.setText(findTestObject('ADMIN/Create New Group/textfield_Group Name'), 'User Group G')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '16Seller')
