...
WebUI.setText(findTestObject('ADMIN/Create New Group/textfield_Group Name'), 'User Group C')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '04Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '05Seller')
