...
WebUI.setText(findTestObject('ADMIN/Create New Group/textfield_Group Name'), 'User Group D')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '06Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '07Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '08Seller')
