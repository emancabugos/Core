...
WebUI.setText(findTestObject('ADMIN/Create New Group/textfield_Group Name'), 'User Group B')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '02Seller')
...
WebUI.setText(findTestObject('ADMIN/Create New Group/textarea dd_Search Merchants'), '03Seller')
