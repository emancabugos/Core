...
WebUI.verifyElementPresent(findTestObject('ADMIN/Admin New Sidebar/submenu_EmailTemplate'), 0)

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin New Sidebar/submenu_MailLog'), 0)
