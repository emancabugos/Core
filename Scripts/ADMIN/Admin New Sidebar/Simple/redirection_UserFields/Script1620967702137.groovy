...
WebUI.waitForElementPresent(findTestObject('ADMIN/Admin New Sidebar/span_User Fields'), 0)

WebUI.click(findTestObject('ADMIN/Admin New Sidebar/span_User Fields'), FailureHandling.CONTINUE_ON_FAILURE)
