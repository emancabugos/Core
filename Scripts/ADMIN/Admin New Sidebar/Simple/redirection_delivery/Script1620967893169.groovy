...
WebUI.waitForElementPresent(findTestObject('ADMIN/Admin New Sidebar/span_Delivery'), 0)

WebUI.click(findTestObject('ADMIN/Admin New Sidebar/span_Delivery'), FailureHandling.CONTINUE_ON_FAILURE)
