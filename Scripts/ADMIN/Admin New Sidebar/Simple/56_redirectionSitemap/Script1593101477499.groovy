...
WebUI.waitForElementPresent(findTestObject('ADMIN/Admin New Sidebar/submenu_Sitemap'), 0)

WebUI.click(findTestObject('ADMIN/Admin New Sidebar/submenu_Sitemap'), FailureHandling.CONTINUE_ON_FAILURE)
