...
WebUI.verifyElementPresent(findTestObject('ADMIN/Admin New Sidebar/menu_ViewMarketplace'), 0)
...
WebUI.waitForElementPresent(findTestObject('ADMIN/Admin New Sidebar/menu_ViewMarketplace'), 0)
