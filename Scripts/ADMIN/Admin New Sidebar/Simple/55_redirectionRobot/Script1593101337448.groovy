...
WebUI.waitForElementPresent(findTestObject('ADMIN/Admin New Sidebar/submenu_Robot'), 0)

WebUI.click(findTestObject('ADMIN/Admin New Sidebar/submenu_Robot'), FailureHandling.CONTINUE_ON_FAILURE)
