...
WebUI.comment('Admin_Image_Consum_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Image_Consum_Yes')
...
WebUI.verifyTextPresent('Admin_Image_Consum_Yes', false)

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.comment('Admin_Image_Merch_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Image_Merch_Yes')
...
WebUI.verifyTextPresent('Admin_Image_Merch_Yes', false)

WebUI.comment('Admin_Image_ConsMer_Yes')

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Image_ConsMer_Yes')
...
WebUI.verifyTextPresent('Admin_Image_ConsMer_Yes', false)

WebUI.comment('Admin_Image_Consum_No')
...
WebUI.verifyTextPresent('Admin_Image_Consum_No', false)

WebUI.comment('Admin_Image_Merch_No')
...
WebUI.verifyTextPresent('Admin_Image_Merch_No', false)
...
WebUI.verifyTextPresent('Admin_Image_ConsMer_No', false)
