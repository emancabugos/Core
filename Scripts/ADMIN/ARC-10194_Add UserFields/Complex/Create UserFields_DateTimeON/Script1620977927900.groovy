...
WebUI.comment('Admin_Date_Consum_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Date_Consum_Yes')
...
WebUI.verifyTextPresent('Admin_Date_Consum_Yes', false)

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.comment('Admin_Date_Merch_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Date_Merch_Yes')
...
WebUI.verifyTextPresent('Admin_Date_Merch_Yes', false)

WebUI.comment('Admin_Date_ConsMer_Yes')

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Date_ConsMer_Yes')
...
WebUI.verifyTextPresent('Admin_Date_ConsMer_Yes', false)

WebUI.comment('Admin_Date_Consum_No')
...
WebUI.verifyTextPresent('Admin_Date_Consum_No', false)
...
WebUI.verifyTextPresent('Admin_Date_Merch_No', false)

WebUI.comment('Admin_Date_ConsMer_No')
...
WebUI.verifyTextPresent('Admin_Date_ConsMer_No', false)
