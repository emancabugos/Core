...
WebUI.comment('Admin_Hyperlink_Consum_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Hyperlink_Consum_Yes')
...
WebUI.verifyTextPresent('Admin_Hyperlink_Consum_Yes', false)

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.comment('Admin_Hyperlink_Merch_Yes')

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Hyperlink_Merch_Yes')
...
WebUI.verifyTextPresent('Admin_Hyperlink_Merch_Yes', false)

WebUI.comment('Admin_Hyperlink_ConsMer_Yes')

WebUI.click(findTestObject('ADMIN/Admin Permission/ARC-10194/button_Add Field'))

WebUI.setText(findTestObject('ADMIN/Admin Permission/ARC-10194/textfield_FieldName'), 'Admin_Hyperlink_ConsMer_Yes')
...
WebUI.verifyTextPresent('Admin_Hyperlink_ConsMer_Yes', false)

WebUI.comment('Admin_Hyperlink_Consum_No')
...
WebUI.verifyTextPresent('Admin_Hyperlink_Consum_No', false)

WebUI.comment('Admin_Hyperlink_Merch_No')
...
WebUI.verifyTextPresent('Admin_Hyperlink_Merch_No', false)

WebUI.comment('Admin_Hyperlink_ConsMer_No')
...
WebUI.verifyTextPresent('Admin_Hyperlink_ConsMer_No', false)
