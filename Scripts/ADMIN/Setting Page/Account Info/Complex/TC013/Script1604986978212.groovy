...
'incorrect email template'
WebUI.setText(findTestObject('ADMIN/Setting Sidebar Menu/textfield_Notification Email_email'), 'abcd.com')
...
WebUI.verifyElementPresent(findTestObject('ADMIN/Setting Sidebar Menu/error_Please enter valid email'), 0)
