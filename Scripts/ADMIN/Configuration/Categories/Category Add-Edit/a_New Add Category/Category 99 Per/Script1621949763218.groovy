...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category 99% ')
...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_category_description'), 'Description64')
