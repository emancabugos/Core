...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category 6.1.1.1.1.1')
...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Categories/Category/dropdown_Parent'), 'Category 6.1.1.1.1', false)
