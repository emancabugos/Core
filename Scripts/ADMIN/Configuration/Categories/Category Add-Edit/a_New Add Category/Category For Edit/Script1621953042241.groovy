...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category For Edit')
...
WebUI.uploadFile(findTestObject('ADMIN/Categories/Category/image_input image'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\Category\\\\22.png')
