...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category 10')
...
WebUI.uploadFile(findTestObject('ADMIN/Categories/Category/image_input image'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\Category\\\\10.png')
...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_category_description'), 'Description10')
