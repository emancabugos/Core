...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_Category Name'), 'Category 5.1.11')
...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Categories/Category/dropdown_Parent'), 'Category 5.1', false)

WebUI.click(findTestObject('ADMIN/Categories/Category/button_Browse'))

WebUI.delay(1)

WebUI.uploadFile(findTestObject('ADMIN/Categories/Category/image_input image'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\Category\\\\5.png')
...
WebUI.setText(findTestObject('ADMIN/Categories/Category/textfield_category_description'), 'Description5')
