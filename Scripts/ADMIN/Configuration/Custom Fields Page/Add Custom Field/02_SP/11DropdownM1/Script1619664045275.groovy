...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Dropdown/textfield_dropdownOpt1'), varCustomFieldName + 'DD1')

WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Dropdown/textfield_dropdownOpt2'), varCustomFieldName + 'DD2')
...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Drop Down_M1')
...
WebUI.click(findTestObject('ADMIN/Custom Field Default Value/dropdown_DEFAULT VALUE1'), FailureHandling.CONTINUE_ON_FAILURE)
