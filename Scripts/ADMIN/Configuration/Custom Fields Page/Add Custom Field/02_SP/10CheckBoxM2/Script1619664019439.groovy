...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Check Box_M2')
...
WebUI.click(findTestObject('ADMIN/Custom Field Default Value/checkbox_DEFAULT VALUE1'), FailureHandling.CONTINUE_ON_FAILURE)
