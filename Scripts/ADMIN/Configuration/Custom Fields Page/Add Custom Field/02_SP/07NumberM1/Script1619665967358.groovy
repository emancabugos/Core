...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Number_M1')
...
WebUI.setText(findTestObject('ADMIN/Custom Field Default Value/number_inputDEFAULT VALUE'), '54')
