...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Text Editor_M')
...
WebUI.setText(findTestObject('ADMIN/Custom Field Default Value/texteditor_inputDEFAULT VALUE'), 'SP_Text Editor_M')
