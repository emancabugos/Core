...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Email_M')
...
WebUI.setText(findTestObject('ADMIN/Custom Field Default Value/email_inputDEFAULT VALUE'), 'arcadierteam@gmail.com')
