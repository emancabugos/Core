...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Percentage_M')
...
WebUI.setText(findTestObject('ADMIN/Custom Field Default Value/precentage_inputDEFAULT VALUE'), '54%')
