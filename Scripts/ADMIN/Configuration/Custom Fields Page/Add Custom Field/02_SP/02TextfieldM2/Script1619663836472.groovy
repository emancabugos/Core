...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'SP_Text field_M2')
...
WebUI.setText(findTestObject('ADMIN/Custom Field Default Value/textfield_inputDEFAULT VALUE'), 'SP_Text field_M2')
