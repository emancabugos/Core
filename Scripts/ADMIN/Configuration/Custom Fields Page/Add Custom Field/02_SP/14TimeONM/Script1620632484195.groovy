...
WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), 'allCat_Date / Time_On_NM')
...
WebUI.click(findTestObject('ADMIN/Custom Field Default Value/datetime_inputDEFAULT VALUE_timepicker'), FailureHandling.CONTINUE_ON_FAILURE)
