...
WebUI.setText(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/textfield_UnitName'), 'Unit All Night Service')

WebUI.delay(1)

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/button_toggle'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Night'), 
    0)

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Night'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_NightWeek'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_NightMonth'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_NightCustom'))
