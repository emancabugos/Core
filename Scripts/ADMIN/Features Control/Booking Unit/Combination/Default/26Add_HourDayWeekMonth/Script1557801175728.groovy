...
WebUI.setText(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/textfield_UnitName'), 'Day 26')

WebUI.delay(1)

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Hour'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Day'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Week'))

WebUI.click(findTestObject('ADMIN/Features Control/Booking Unit/a_Add New Booking Unit/checkbox_Month'))
