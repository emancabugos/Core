...
WebUI.click(findTestObject('ADMIN/Features Control/Advance Search/button_Search by keywords'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.click(findTestObject('ADMIN/Features Control/Advance Search/toggle_date filter keyword'), FailureHandling.CONTINUE_ON_FAILURE)
