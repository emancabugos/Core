...
WebUI.waitForElementVisible(findTestObject('ADMIN/Setup Payments/a_Paypal/button_LoginToPaypal'), 0)

WebUI.click(findTestObject('ADMIN/Setup Payments/a_Paypal/button_LoginToPaypal'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Setup Payments/a_Paypal/textfield_email'), 0)

WebUI.setText(findTestObject('ADMIN/Setup Payments/a_Paypal/textfield_email'), 'hiveboxstaging01@yopmail.com')
...
WebUI.verifyElementText(findTestObject('ADMIN/Setup Payments/a_Paypal/textlabelvalue_PaypalAccount'), 'hiveboxstaging01@yopmail.com')
