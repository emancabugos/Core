...
'Verify deleted item is not present in the Item Details\r\n\r\n'
...
WebUI.verifyElementNotHasAttribute(findTestObject('CONSUMER/Search Result Page/itemName_SearchResultPage'), '', 0)
