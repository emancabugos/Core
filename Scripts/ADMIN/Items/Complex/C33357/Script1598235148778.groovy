...
'Verify deleted item is not present in the Search Result Page\r\n\r\n\r\n'
...
WebUI.verifyElementNotHasAttribute(findTestObject('CONSUMER/Search Result Page/itemName_SearchResultPage'), itemname, 0)
