...
'Verify deleted item is not present in the Merchant Storefront\r\n\r\n\r\n'
...
WebUI.setText(findTestObject('MERCHANT/Merchant Storefront/textfield_StorefrontSearch'), '')

WebUI.delay(1)

WebUI.click(findTestObject('MERCHANT/Merchant Storefront/button_search'))

WebUI.waitForElementVisible(findTestObject('MERCHANT/Merchant Storefront/textlabel_itemName'), 0)

WebUI.verifyElementNotHasAttribute(findTestObject('MERCHANT/Merchant Storefront/textlabel_itemName'), '', 0)
