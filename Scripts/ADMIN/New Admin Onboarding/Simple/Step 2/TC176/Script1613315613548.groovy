...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_Last Name_LastName'), 'Marketplace')
...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_Postal Code_PostCode'), '1200')

WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_Please do not enter any spaces'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_Please do not enter any spaces'), 
    'value', '', 0)
