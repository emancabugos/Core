...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_First Name_FirstName'), dateToday + 'SpacetimeTheme3')
...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 3/input_Give Your Marketplace'), dateToday + 'SpacetimeTheme3')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 4/btn_selectServiceTheme3'), FailureHandling.CONTINUE_ON_FAILURE)
