...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_First Name_FirstName'), dateToday + 'BespokeTheme2')
...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 3/input_Give Your Marketplace'), dateToday + 'BespokeTheme2')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 4/btn_selectRetailTheme2'), FailureHandling.CONTINUE_ON_FAILURE)
