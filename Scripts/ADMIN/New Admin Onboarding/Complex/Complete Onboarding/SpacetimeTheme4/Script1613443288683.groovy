...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_First Name_FirstName'), dateToday + 'SpacetimeTheme4')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 3/btn_selectBookingListings'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 3/input_Give Your Marketplace'), dateToday + 'SpacetimeTheme4')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 4/btn_selectServiceTheme4'), FailureHandling.CONTINUE_ON_FAILURE)
