...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_First Name_FirstName'), dateToday + 'SpacetimeTheme1')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 4/btn_selectServiceTheme1'), FailureHandling.CONTINUE_ON_FAILURE)
