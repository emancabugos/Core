...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 2/input_First Name_FirstName'), dateToday + 'BespokeTheme4')
...
WebUI.setText(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 3/input_Give Your Marketplace'), dateToday + 'BespokeTheme4')
...
WebUI.click(findTestObject('ADMIN/New Admin Onboarding/Onboarding Step 4/btn_selectRetailTheme4'), FailureHandling.CONTINUE_ON_FAILURE)
