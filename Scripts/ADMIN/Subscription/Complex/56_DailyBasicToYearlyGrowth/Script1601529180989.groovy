...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Subscription/dropdown_Plan'), 'Yearly (3 Days)', false)

WebUI.delay(2)

WebUI.click(findTestObject('ADMIN/Subscription/a_buttonUpgradewithBanner/button_yearlyGrowthUpgrade'))
