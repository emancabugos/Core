...
WebUI.verifyElementText(findTestObject('ADMIN/Subscription/a_buttonUpgradewithBanner/button_dailyGrowthUpgrade'), 'Selected')

WebUI.click(findTestObject('ADMIN/Subscription/a_buttonUpgradewithBanner/button_dailyScaleUpgrade'))
