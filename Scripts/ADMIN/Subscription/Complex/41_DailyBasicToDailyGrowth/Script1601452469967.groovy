...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Subscription/dropdown_Plan'), 'Daily', false)

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('ADMIN/Subscription/a_buttonUpgradewithBanner/button_dailyBasicUpgrade'), 'Selected')

WebUI.click(findTestObject('ADMIN/Subscription/a_buttonUpgradewithBanner/button_dailyGrowthUpgrade'))
