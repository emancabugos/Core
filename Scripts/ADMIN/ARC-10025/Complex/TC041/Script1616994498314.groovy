...
comname = WebUI.getText(findTestObject('ADMIN/ARC-10027/Page_0613bpdiana/textfield_Commission Name'))

WebUI.sendKeys(findTestObject('ADMIN/ARC-10027/Page_0613bpdiana/textfield_Commission Name'), 'edit')
