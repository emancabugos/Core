...
WebUI.verifyOptionSelectedByValue(findTestObject('ADMIN/Date Format Settings/dropdown_PickDateType'), 'Year', false, 0)

WebUI.verifyOptionSelectedByValue(findTestObject('ADMIN/Date Format Settings/dropdown_SelectFormat'), 'Two digit year (30)', 
    false, 0)
