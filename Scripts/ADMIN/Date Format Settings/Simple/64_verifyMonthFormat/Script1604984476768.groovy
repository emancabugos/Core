...
WebUI.verifyOptionsPresent(findTestObject('ADMIN/Date Format Settings/dropdown_SelectFormat'), ['Month without leading zero (8)'
        , 'Month with leading zero (08)', 'Month as abbreviation (Aug)', 'Month as full name (August)'])
