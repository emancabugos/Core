...
WebUI.verifyOptionsPresent(findTestObject('ADMIN/Date Format Settings/dropdown_SelectFormat'), ['Day without leading zero (5)'
        , 'Day with leading zero (05)', 'Day with ordinal (5th)'])
