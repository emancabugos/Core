...
WebUI.verifyOptionSelectedByValue(findTestObject('ADMIN/Date Format Settings/dropdown_PickDateType'), 'Day', false, 0)

WebUI.verifyOptionSelectedByValue(findTestObject('ADMIN/Date Format Settings/dropdown_SelectFormat'), 'Day without leading zero (5)', 
    false, 0)
