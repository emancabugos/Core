...
def formattedDate = date.format('MMMM/yyyy/d')
...
switch (true) {
    case day.charAt(0) == 1:
        converted_date = (((((month + '/') + year) + '/') + day) + 'st')

        println(converted_date)

        break
    case day.charAt(0) == 2:
        converted_date = (((((month + '/') + year) + '/') + day) + 'nd')

        println(converted_date)

        break
    case day.charAt(0) == 3:
        converted_date = (((((month + '/') + year) + '/') + day) + 'rd')

        println(converted_date)

        break
    default:
        converted_date = (((((month + '/') + year) + '/') + day) + 'th')
