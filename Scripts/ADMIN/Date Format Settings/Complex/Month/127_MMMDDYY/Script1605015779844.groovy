...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Date Format Settings/button_MM'), 'value', 'DD', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Date Format Settings/button_YYYY'), 'value', 'YY', 0)

def date = new Date()

def formattedDate = date.format('MMM/dd/yy')

println(formattedDate)

PreviewDatetmp.text = formattedDate
DateFormattmp.text = 'MMM/dd/yy'
