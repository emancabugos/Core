...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Date Format Settings/button_DD'), 'value', 'MMM', 0)
...
def formattedDate = date.format('MMM/d/yy')
