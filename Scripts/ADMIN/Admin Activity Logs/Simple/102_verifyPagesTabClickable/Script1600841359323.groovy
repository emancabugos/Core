...
WebUI.verifyElementClickable(findTestObject('ADMIN/Admin Activity Logs/tab_Pages'))

WebUI.click(findTestObject('ADMIN/Admin Activity Logs/tab_Pages'))
...
WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Activity Logs/column_PageURL'), 0)
