...
WebUI.setText(findTestObject('ADMIN/New Item List/textbox_search'), 'Nego to Instant')
...
WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Edit Item Spacetime/checkbox_ Negotiation'), 0)
