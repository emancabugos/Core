...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_FAQ'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_FAQ'), FailureHandling.CONTINUE_ON_FAILURE)
