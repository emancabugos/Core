...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Cookie Policy'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Cookie Policy'), FailureHandling.CONTINUE_ON_FAILURE)
