...
WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/dd_icon EDM'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Offer Declined (To Seller)'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Offer Declined (To Seller)'), FailureHandling.CONTINUE_ON_FAILURE)
