...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Reset Password'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Reset Password'), FailureHandling.CONTINUE_ON_FAILURE)
