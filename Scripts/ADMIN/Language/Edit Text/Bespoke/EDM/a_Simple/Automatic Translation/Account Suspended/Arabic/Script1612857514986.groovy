...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Account Suspended/textarea_It seems that your it'), 
    'value', 'يبدو أن العناصر الخاصة بك لم تعد قابلة للاكتشاف في الوقت الراهن! ستتلقى رسالة إلكترونية تحتوي على مزيد من المعلومات قريبا. إذا كنت لا تتلقى البريد الإلكتروني، يرجى الاتصال بنا على', 
    0)
