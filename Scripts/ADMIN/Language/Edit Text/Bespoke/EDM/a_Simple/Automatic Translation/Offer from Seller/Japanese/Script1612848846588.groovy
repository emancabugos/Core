...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Offer from Seller/input_You have a new offer'), 
    'value', 'あなたは新しいオファーを持っています', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Offer from Seller/input_Hi'), 'value', 'こんにちは', 
    0)
