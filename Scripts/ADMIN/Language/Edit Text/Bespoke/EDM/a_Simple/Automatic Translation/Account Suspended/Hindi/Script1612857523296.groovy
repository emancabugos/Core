...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Account Suspended/textarea_It seems that your it'), 
    'value', 'ऐसा लगता है कि आपके आइटम अब इस समय खोज योग्य नहीं हैं! आप शीघ्र ही अधिक जानकारी के साथ एक ईमेल प्राप्त करेंगे यदि आपको ईमेल नहीं मिला है, तो कृपया हमसे संपर्क करें', 
    0)
