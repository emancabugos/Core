...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/input_lbl_hi'), 'value', 'مرحبا', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/textarea_We are excited to hav'), 
    'value', 'نحن متحمسون أن يكون لك على متن الطائرة! ونحن نتطلع إلى ملء الخاص بك متجرك مع الكثير والكثير من العناصر!', 
    0)
