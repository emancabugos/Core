...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/input_lbl_hi'), 'value', 'Hallo', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/textarea_We are excited to hav'), 
    'value', 'Wir freuen uns, Sie an Bord zu haben! Wir freuen uns auf Sie, bis Sie Ihr Geschäft mit vielen und vielen Artikeln ausfüllen!', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/input_btn_next'), 'value', 
    'JETZT EINZELTEIL HINZUFÜGEN!', 0)
