...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_lbl_hi'), 'value', 'مرحبا', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/textarea_Your order is ready f'), 
    'value', 'طلبك جاهز لالتقاط!', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_invoice-id'), 'value', 
    'هوية صوتية', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_btn_next'), 'value', 'عرض أوامر', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/textarea_Please pick up your i'), 
    'value', 'يرجى التقاط البند الخاص بك من العنوان أعلاه! إذا كان لديك أي أسئلة حول طلبك لا تتردد في الاتصال البائع أو ترك لنا رسالة بالبريد الالكتروني في', 
    0)
