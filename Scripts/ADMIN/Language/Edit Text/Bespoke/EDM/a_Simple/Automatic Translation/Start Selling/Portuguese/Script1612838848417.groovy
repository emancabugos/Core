...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/input_lbl_hi'), 'value', 'Oi', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/textarea_We are excited to hav'), 
    'value', 'Estamos ansiosos por tê-lo a bordo! Estamos ansiosos para você preencher sua loja com muitos itens!', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Start Selling/input_btn_next'), 'value', 
    'ADICIONAR ITEM AGORA!', 0)
