...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_order-ready'), 'value', 
    'Ihre Bestellung ist fertig!', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_lbl_hi'), 'value', 'Hallo', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/textarea_Your order is ready f'), 
    'value', 'Ihre Bestellung ist bereit zur Abholung!', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_invoice-id'), 'value', 
    'RECHNUNGS-ID', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/input_btn_next'), 'value', 'ANSICHTEN', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Order Pickup/textarea_Please pick up your i'), 
    'value', 'Bitte heben Sie Ihren Artikel aus der oben genannten Adresse auf! Wenn Sie Fragen zu Ihrer Bestellung haben, wenden Sie sich bitte an Ihren Verkäufer oder schicken Sie uns eine E-Mail an', 
    0)
