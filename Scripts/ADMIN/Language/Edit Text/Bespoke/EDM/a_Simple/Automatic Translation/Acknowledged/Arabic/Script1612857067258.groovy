...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Acknowledged/input_lbl_OrderAcknowledged'), 
    'value', 'النظام المعترف بها', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Acknowledged/input_lbl_hi'), 'value', 'مرحبا', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Acknowledged/textarea_The seller had acknow'), 
    'value', 'اعترف البائع بطلبك. لقد حددت "{{}}" كخيار الدفع الخاص بك. تذكر أن تدفع عند استلام أو استلام طلبك!', 0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Acknowledged/textarea_If you have any quest'), 
    'value', 'إذا كان لديك أي أسئلة حول طلبك، لا تتردد في الاتصال البائع أو ترك لنا رسالة بالبريد الالكتروني في', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Acknowledged/input_regards'), 'value', 'مع تحياتي', 
    0)
