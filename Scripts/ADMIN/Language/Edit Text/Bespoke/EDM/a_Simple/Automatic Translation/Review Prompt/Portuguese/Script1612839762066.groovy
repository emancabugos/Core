...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/input_welcome-to'), 'value', 
    'Revise sua compra recente', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/input_lbl_hi'), 'value', 'Oi', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/input_thanks-for-purchase'), 
    'value', 'Obrigado pela sua compra recente!', 0)
...
WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/textarea_We were hoping you wo'), 
    'value', 'Esperávamos que você nos deixasse, e todos os outros, saber o que você pensa da sua compra! Você pode rever uma compra clicando no botão "Deixar um feedback" abaixo, só levará alguns minutos.', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/input_login-id'), 'value', 
    'Deixe um comentário', 0)

WebUI.verifyElementAttributeValue(findTestObject('ADMIN/Edit Text/Bespoke/EDMs/Review Prompt/input_thx-txt'), 'value', 'Obrigado e esperamos vê-lo novamente em breve!', 
    0)
