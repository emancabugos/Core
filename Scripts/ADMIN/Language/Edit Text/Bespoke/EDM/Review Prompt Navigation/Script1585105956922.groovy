...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Review Prompt'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Review Prompt'), FailureHandling.CONTINUE_ON_FAILURE)
