...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Acknowledged'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Acknowledged'), FailureHandling.CONTINUE_ON_FAILURE)
