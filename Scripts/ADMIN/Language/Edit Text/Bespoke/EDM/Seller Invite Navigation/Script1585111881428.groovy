...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Seller Invite'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/EDM Navigation/span_Seller Invite'), FailureHandling.CONTINUE_ON_FAILURE)
