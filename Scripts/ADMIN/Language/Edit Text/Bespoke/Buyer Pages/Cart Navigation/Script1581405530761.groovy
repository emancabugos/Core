...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Buyer Navigation/textlink_Cart'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Buyer Navigation/textlink_Cart'), FailureHandling.CONTINUE_ON_FAILURE)
