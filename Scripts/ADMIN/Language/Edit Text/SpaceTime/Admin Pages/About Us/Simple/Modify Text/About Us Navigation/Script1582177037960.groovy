...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_About Us'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_About Us'), FailureHandling.CONTINUE_ON_FAILURE)
