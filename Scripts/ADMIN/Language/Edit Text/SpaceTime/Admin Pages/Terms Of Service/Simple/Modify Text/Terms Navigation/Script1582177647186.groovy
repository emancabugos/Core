...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Terms of Service'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Terms of Service'), FailureHandling.CONTINUE_ON_FAILURE)
