...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/collapseButton_AdminPages'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/collapseButton_AdminPages'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_MarketplaceHeaderFooter'), 
    0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_MarketplaceHeaderFooter'), FailureHandling.CONTINUE_ON_FAILURE)
