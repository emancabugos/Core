...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Marketplace Header  Footer'), 
    0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Admin Navigation/span_Marketplace Header  Footer'), FailureHandling.CONTINUE_ON_FAILURE)
