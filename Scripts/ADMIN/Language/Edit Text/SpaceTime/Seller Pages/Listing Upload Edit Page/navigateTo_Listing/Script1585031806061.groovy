...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_ListingUploadEdit Page'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_ListingUploadEdit Page'), FailureHandling.CONTINUE_ON_FAILURE)
