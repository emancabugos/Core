...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_Dashboard'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_Dashboard'), FailureHandling.CONTINUE_ON_FAILURE)
