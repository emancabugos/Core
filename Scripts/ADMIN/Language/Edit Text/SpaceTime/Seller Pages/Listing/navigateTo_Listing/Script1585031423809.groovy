...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_Listing'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_Listing'), FailureHandling.CONTINUE_ON_FAILURE)
