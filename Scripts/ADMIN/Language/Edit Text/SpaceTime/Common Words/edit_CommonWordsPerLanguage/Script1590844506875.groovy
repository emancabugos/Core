...
WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Time/textfield_Weeks'), '*')
...
WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Scheduling (Uploads Bookings)/textfield_February'), 
    '*')
...
WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Profile Info/textfield_FirstName'), '*')

WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Profile Info/textfield_LastName'), '*')

WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Profile Info/textfield_NotificationEmail'), '*')

WebUI.sendKeys(findTestObject('ADMIN/Edit Text/Spacetime/Common Words/Profile Info/textfield_ContactNumber'), '*')
