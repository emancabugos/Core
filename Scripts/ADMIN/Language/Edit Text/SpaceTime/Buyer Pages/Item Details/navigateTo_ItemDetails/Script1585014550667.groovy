...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_ItemDetails'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Spacetime/Language Menu/linktext_ItemDetails'), FailureHandling.CONTINUE_ON_FAILURE)
