...
String orderdetailstatus = WebUI.getText(findTestObject('SPACETIME/CONSUMER/Purchase History Details/Page_0803time/textlabel_Order status_PList'))

WebUI.sendKeys(findTestObject('SPACETIME/MERCHANT/Booking List/textbox_search'), Keys.chord(Keys.ENTER))

WebUI.verifyMatch(orderdetailstatus, 'Ready for Pickup', false)
