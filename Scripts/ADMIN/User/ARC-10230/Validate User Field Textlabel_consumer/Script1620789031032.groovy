...
txtfieldconyes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_textfield_Consum_Yes'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_textfield_Consum_Yes', txtfieldconyes, false)
...
txtfieldconNO = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_textfield_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_textfield_Consum_No', txtfieldconNO, false)
...
ddmeryes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_dropdwn_Consum_Yes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_dropdwn_Consum_Yes', ddmeryes, false)
...
ddmerchno = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_dropdwn_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_dropdwn_Consum_No', ddmerchno, false)
...
ccmeryes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_checkbx_Consum_Yes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_checkbx_Consum_Yes', ccmeryes, false)
...
ccmerno = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_checkbx_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_checkbx_Consum_No', ccmerno, false)
...
pdfmeryes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_PDF_Consum_Yes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_PDF_Consum_Yes', pdfmeryes, false)
...
pdfmerno = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_PDF_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_PDF_Consum_No', pdfmerno, false)
...
datemeryes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_Date_Consum_Yes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_Date_Consum_Yes', datemeryes, false)
...
datemerno = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_Date_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_Date_Consum_No', datemerno, false)
...
datemeryes = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_Image_Consum_Yes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_Image_Consum_Yes', datemeryes, false)
...
datemerno = WebUI.getText(findTestObject('ADMIN/User Details/ARC-10230/Consumer/label_Admin_Image_Consum_No'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch('Admin_Image_Consum_No', datemerno, false)
...
WebUI.verifyMatch('Admin_Hyperlink_Consum_Yes', hypemeryes, false)
...
WebUI.verifyMatch('Admin_Hyperlink_Consum_No', hypemerno, false)
