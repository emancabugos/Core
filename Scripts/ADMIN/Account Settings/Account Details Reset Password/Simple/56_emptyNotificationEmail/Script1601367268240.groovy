...
WebUI.clearText(findTestObject('ADMIN/Reset Password/textfield_NotificationEmail'))

WebUI.click(findTestObject('ADMIN/Reset Password/button_Save'))

css_color = WebUI.getCSSValue(findTestObject('ADMIN/Reset Password/textfield_NotificationEmail'), 'color')
