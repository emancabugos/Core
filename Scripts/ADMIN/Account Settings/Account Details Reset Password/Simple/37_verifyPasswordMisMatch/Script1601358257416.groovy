...
WebUI.setText(findTestObject('ADMIN/Reset Password/textfield_ConfirmNewPassword'), '7654321')

WebUI.click(findTestObject('ADMIN/Reset Password/button_Save'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Reset Password/warning_PasswordMisMatch'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Reset Password/warning_PasswordMisMatch'), FailureHandling.CONTINUE_ON_FAILURE)
