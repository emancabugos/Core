...
WebUI.waitForElementVisible(findTestObject('ADMIN/Account Info/button_Edit'), 0)
...
WebUI.setText(findTestObject('ADMIN/Admin Login Page/textbox_password'), '1234567')
...
WebUI.waitForElementVisible(findTestObject('ADMIN/Announcement/icon_Announcement'), 0)

WebUI.verifyElementVisible(findTestObject('ADMIN/Announcement/icon_Announcement'), FailureHandling.CONTINUE_ON_FAILURE)
