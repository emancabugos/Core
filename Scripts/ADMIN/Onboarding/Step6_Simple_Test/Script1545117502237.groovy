...
WebUI.comment('Step 6 (editable variables)')
...
WebUI.click(findTestObject('ADMIN/Admin Onboarding Page/Admin_Onboarding_Step6/Button_PREVIOUS_Step6'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('ADMIN/Admin Onboarding Page/Admin_Onboarding_Step5/Button_Next_Step5'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Admin Onboarding Page/Admin_Onboarding_Step6/Textlabel_Select your marketplace'), 
    0)

WebUI.comment('Upload Cover Image')
...
WebUI.uploadFile(findTestObject('ADMIN/Admin Onboarding Page/Admin_Onboarding_Step6/Image_Container'), 'C:\\\\Katalon\\\\Image\\\\coverimage2.jpg')
