...
WebUI.sendKeys(findTestObject('ADMIN/Commission/Page_0902space/input_Default commission_searchTextValue'), Keys.chord(Keys.ENTER))

WebUI.verifyMatch(searchcat, 'CAT 1', false)
