...
actualdiscount = WebUI.getText(findTestObject('ADMIN/Commission/ARC-9351/seller_discount value'))
...
String nactualdiscount = actualdiscount 

def nwactualdiscount = nactualdiscount.replace(',', '')

BigDecimal fnwactualdiscount = new BigDecimal(nwactualdiscount)

println(fnwactualdiscount)
...
def adminfee = (fnewSub - fnwactualdiscount) * comfloat
