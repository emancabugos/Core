...
WebUI.waitForElementVisible(findTestObject('ADMIN/ARC-9449/Page_0613bpdiana/span_Admin Activity Log'), 0)

WebUI.click(findTestObject('ADMIN/ARC-9449/Page_0613bpdiana/span_Admin Activity Log'))
