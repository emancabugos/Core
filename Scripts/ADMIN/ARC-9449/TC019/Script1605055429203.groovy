...
WebUI.waitForElementVisible(findTestObject('ADMIN/ARC-9449/Page_0613bpdiana/span_Merchant Sub-Accounts'), 0)

WebUI.click(findTestObject('ADMIN/ARC-9449/Page_0613bpdiana/span_Merchant Sub-Accounts'))
