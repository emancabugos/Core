...
WebUI.setText(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/textfield_Commission Name'), 'Merchant Group 5')
...
WebUI.setText(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/Page_0613bpdiana/input_Search Merchant Groups'), 'User Group G', 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/checkbox_7th value'))
...
WebUI.verifyTextPresent('Merchant Group E', false)
