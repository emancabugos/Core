...
WebUI.setText(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/textfield_Commission Name'), 'Merchant Group 6')
...
WebUI.click(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/checkbox_8th value'))
...
WebUI.setText(findTestObject('ADMIN/ARC-10027_ADD MLC/Page_0613bpdiana/textfield_Commission fee'), '20')
