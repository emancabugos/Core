...
WebUI.waitForElementNotPresent(findTestObject('MOGOZAY/Admin/categorySyncToaster'), 0)
...
WebUI.waitForElementVisible(findTestObject('ADMIN/Categories/Category/dropdown_Parent'), 2)
