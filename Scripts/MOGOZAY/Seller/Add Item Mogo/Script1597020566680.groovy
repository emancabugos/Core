...
if (varCategory == 'Category 0%') {
    WebUI.waitForElementVisible(findTestObject('MOGOZAY/Seller/Add Item/category 0'), 0)

    WebUI.click(findTestObject('MOGOZAY/Seller/Add Item/category 0'), FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.delay(2, FailureHandling.CONTINUE_ON_FAILURE)
} else if (varCategory == 'Category 1%') {
    WebUI.waitForElementVisible(findTestObject('MOGOZAY/Seller/Add Item/category 1'), 0)

    WebUI.click(findTestObject('MOGOZAY/Seller/Add Item/category 1'), FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.delay(2, FailureHandling.CONTINUE_ON_FAILURE)
} else if (varCategory == 'Category 99%') {
    WebUI.waitForElementVisible(findTestObject('MOGOZAY/Seller/Add Item/category 99'), 0)

    WebUI.click(findTestObject('MOGOZAY/Seller/Add Item/category 99'), FailureHandling.CONTINUE_ON_FAILURE)
} else if (varCategory == 'Category 100%') {
    WebUI.waitForElementVisible(findTestObject('MOGOZAY/Seller/Add Item/category 100'), 0)

    WebUI.click(findTestObject('MOGOZAY/Seller/Add Item/category 100'), FailureHandling.CONTINUE_ON_FAILURE)
}
...
if (varVariants == 'yes') {
    ...
    if (varStock == 'unlimited') {
        ...
        WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Add Item/textbox_qty'), '0')
    }
}
