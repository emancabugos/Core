...
WebUI.setText(findTestObject('FIND/SELLER/onboardingProfile/textbox_DisplayName'), '01Seller')

WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/onboardingProfile/dd_sellerType'), 'Distributor', false)

WebUI.setText(findTestObject('FIND/SELLER/onboardingProfile/textarea_companyOverview'), 'I am the first seller.')
