...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Find/textarea_independent'), 'Text EDITOR')
...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Find/hs code'), 'CODE123')
...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Find/contact'), '+1234567890')
...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Find/textarea_country'), 'Text EDITOR')

WebUI.click(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Find/cbOperation1'))
