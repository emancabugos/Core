...
WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/input_Choose start date'), '15/04/2022')

WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/input_Choose start time'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/input_Choose end date'), '15/04/2022')

WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/input_Choose end time'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/btn_Block this datetime'))

WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/button_Delete'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Service Creation/Blockout Dates/button_Delete'), FailureHandling.CONTINUE_ON_FAILURE)
