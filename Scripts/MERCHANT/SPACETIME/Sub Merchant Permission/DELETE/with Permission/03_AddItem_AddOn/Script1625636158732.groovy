...
WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Add Ons/textbox_add on name'), 'Test Add On')

WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Add Ons/textbox_surcharge'), '150')

WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Add Ons/button_Add'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Service Creation/Add Ons/button_Delete'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Service Creation/Add Ons/button_Delete'), FailureHandling.CONTINUE_ON_FAILURE)
