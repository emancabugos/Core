...
WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Location/textbox_address'), 'The Cue 1525 Harvard Ave')
...
WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Location/textbox_state'), 'Washington')

WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Location/textbox_city'), 'Seattle')

WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Location/textbox_postalcode'), '98122')
...
WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Service Creation/Delivery/button_Upload now'), FailureHandling.CONTINUE_ON_FAILURE)
