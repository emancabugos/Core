...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), 'per Day 24/7 D')
...
WebUI.mouseOver(findTestObject('SPACETIME/CONSUMER/Chat Details Page/button_Send'), FailureHandling.CONTINUE_ON_FAILURE)
