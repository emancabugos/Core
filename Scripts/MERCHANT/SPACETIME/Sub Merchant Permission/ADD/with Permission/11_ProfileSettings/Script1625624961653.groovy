...
WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/User Custom Fields/upload_Admin_Image_Merch_Yes'))

WebUI.verifyTextPresent('You need permission to perform this action', false)

WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/User Custom Fields/upload_Admin_Image_Merch_No'))

WebUI.verifyTextPresent('You need permission to perform this action', false)

WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/User Custom Fields/upload_Admin_PDF_Merch_Yes'))

WebUI.verifyTextPresent('You need permission to perform this action', false)

WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/User Custom Fields/upload_Admin_PDF_Merch_No'))
