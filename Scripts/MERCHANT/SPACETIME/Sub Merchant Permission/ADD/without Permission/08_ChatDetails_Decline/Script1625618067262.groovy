...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Date'), '08/01/2022')
...
WebUI.mouseOver(findTestObject('SPACETIME/CONSUMER/Chat Details Page/button_Decline'), FailureHandling.CONTINUE_ON_FAILURE)
