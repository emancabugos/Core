...
WebUI.verifyElementVisible(findTestObject('SPACETIME/MERCHANT/Listing Page/button_Add listings'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Listing Page/button_Add listings'), FailureHandling.CONTINUE_ON_FAILURE)
