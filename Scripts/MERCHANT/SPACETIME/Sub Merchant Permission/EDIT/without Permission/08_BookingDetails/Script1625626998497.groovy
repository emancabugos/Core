...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking details/dd_Order Status'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Booking details/dd_Order Status'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyTextPresent('You need permission to perform this action', false)

WebUI.delay(1)

WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking details/icon_edit'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Booking details/icon_edit'), FailureHandling.CONTINUE_ON_FAILURE)
