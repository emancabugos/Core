...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking List/dd_status'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Booking List/dd_status'), FailureHandling.CONTINUE_ON_FAILURE)
