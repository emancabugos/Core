...
WebUI.verifyElementVisible(findTestObject('SPACETIME/MERCHANT/Listing Page/icon_edit'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Listing Page/icon_edit'), FailureHandling.CONTINUE_ON_FAILURE)
