...
WebUI.waitForElementVisible(findTestObject('SPACETIME/CONSUMER/Chat Details Page/button_CreateOffer'), 0)

WebUI.verifyElementPresent(findTestObject('SPACETIME/CONSUMER/Chat Details Page/button_CreateOffer'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/CONSUMER/Chat Details Page/button_CreateOffer'), FailureHandling.CONTINUE_ON_FAILURE)
