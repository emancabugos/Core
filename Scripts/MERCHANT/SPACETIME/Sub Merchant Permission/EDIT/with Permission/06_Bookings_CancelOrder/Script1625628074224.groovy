...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking List/button_Cancel Order'), 0)

WebUI.mouseOver(findTestObject('SPACETIME/MERCHANT/Booking List/button_Cancel Order'), FailureHandling.CONTINUE_ON_FAILURE)
