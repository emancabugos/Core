...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Onboarding/Profile/textbox_FirstName'), 0)

WebUI.verifyElementVisible(findTestObject('SPACETIME/MERCHANT/Onboarding/Profile/textbox_FirstName'), FailureHandling.CONTINUE_ON_FAILURE)
