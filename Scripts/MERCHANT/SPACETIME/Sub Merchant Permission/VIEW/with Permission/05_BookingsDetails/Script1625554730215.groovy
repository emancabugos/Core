...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking details/Button_back to List'), 0)

WebUI.verifyElementVisible(findTestObject('SPACETIME/MERCHANT/Booking details/Button_back to List'), FailureHandling.CONTINUE_ON_FAILURE)
