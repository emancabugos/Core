...
WebUI.setText(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_listingName'), 'per Night Month D')
...
WebUI.uploadFile(findTestObject('SPACETIME API/MERCHANT/Create Listing/03_Add Image/img_container'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\UN Items\\\\item20.jpg')
