...
WebUI.setText(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_listingName'), 'per Hour NOT 24/7 D')
...
WebUI.uploadFile(findTestObject('SPACETIME API/MERCHANT/Create Listing/03_Add Image/img_container'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\UN Items\\\\item17.jpg')
...
WebUI.click(findTestObject('SPACETIME API/MERCHANT/Create Listing/sd_ hour'))
