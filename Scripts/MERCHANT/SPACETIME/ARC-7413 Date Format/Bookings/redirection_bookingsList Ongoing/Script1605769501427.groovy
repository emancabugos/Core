...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Booking List/dd_ongoing past'), 0)

WebUI.selectOptionByLabel(findTestObject('SPACETIME/MERCHANT/Booking List/dd_ongoing past'), 'Ongoing/past', false)
