...
WebUI.setText(findTestObject('Time/Merchant/User Settings/textfield_DisplayName'), '                                                                                         ')
...
WebUI.verifyElementPresent(findTestObject('Time/Merchant/User Settings/textfield_DisplayName'), 0)


//Empty Display Name

WebUI.clearText(findTestObject("Time/Merchant/User Settings/textfield_DisplayName"))
