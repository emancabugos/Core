...
WebUI.waitForElementVisible(findTestObject('ADMIN/Private Settings/button_View Buyer List'), 0)
...
WebUI.waitForElementVisible(findTestObject('Time/Consumer/Private Login Page/button_CreateAccount_Private'), 0)
