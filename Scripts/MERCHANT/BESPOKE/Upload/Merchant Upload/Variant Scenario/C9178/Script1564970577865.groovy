...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/input_item-name'), 'C9177')

WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/textbox_sku-field'), 'C9177SKU')
...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/Variants/textbox_choices1'), 'A,')
