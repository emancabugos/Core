...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/input_item-name'), 'C9174')

WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/textbox_sku-field'), 'C9174SKU')
...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/Variants/textbox_opt1'), '20Character20Charactss')
