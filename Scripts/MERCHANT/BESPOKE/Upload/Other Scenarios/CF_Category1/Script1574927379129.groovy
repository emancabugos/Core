...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page/category1/textfield1'), 'Text1')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page/category1/textfield2'), 'Text2')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page/Allcat/p'), 'TextEDITOR')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page/category1/hyperlink'), 'arcadier.com')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page/category1/email'), 'arcadierteam@gmail.com')
