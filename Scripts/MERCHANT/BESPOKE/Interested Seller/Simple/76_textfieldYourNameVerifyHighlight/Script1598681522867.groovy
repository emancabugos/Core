...
WebUI.waitForElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Interested User/radiobutton_Seller'), 0)
...
css_color = WebUI.getCSSValue(findTestObject('BESPOKE DEL 2/CONSUMER/Interested User/textfield_YourName'), 'color')
