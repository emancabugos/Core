...
WebUI.setText(findTestObject('Utilities/Custom Fields/percentage'), '')

WebUI.delay(1)

WebUI.click(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('Utilities/Custom Fields/percentage'), 'value', '', 0)
