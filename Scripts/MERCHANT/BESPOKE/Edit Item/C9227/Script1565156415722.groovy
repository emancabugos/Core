...
WebUI.setText(findTestObject('Utilities/Custom Fields/input_txt-field'), '')

WebUI.delay(1)

WebUI.click(findTestObject('BESPOKE DEL 2/MERCHANT/Upload Page (1)/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('Utilities/Custom Fields/input_txt-field'), 'value', '', 0)
