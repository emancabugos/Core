...
WebUI.verifyElementAttributeValue(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Allcat/number1'), 'value', 
    '', 0)

WebUI.verifyElementAttributeValue(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Allcat/number2'), 'value', 
    '', 0)
