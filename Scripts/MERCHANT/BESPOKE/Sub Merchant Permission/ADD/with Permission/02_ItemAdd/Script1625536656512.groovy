...
WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Add Item/icon_browse'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Variants/placeholder_image'))

WebUI.verifyTextNotPresent('You need permission to perform this action', false)

WebUI.comment('Item Description')

WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Add Item/textbox_item-description'), 'Description01')

WebUI.comment('Custom Fields')

WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Custom Fields/Allcat/pdf1'))
...
WebUI.mouseOver(findTestObject('BESPOKE DEL 2/MERCHANT/Add Item Page/Add Item/button_Upload Now'), FailureHandling.CONTINUE_ON_FAILURE)
