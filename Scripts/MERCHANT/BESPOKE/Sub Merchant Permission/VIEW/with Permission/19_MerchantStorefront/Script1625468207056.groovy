...
WebUI.click(findTestObject('BESPOKE DEL 2/CONSUMER/Item Details/text_sellerDisplayName'))

WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/StoreFront/tab_ITEM REVIEWS'), 0)

WebUI.verifyElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/StoreFront/tab_ITEM REVIEWS'), FailureHandling.CONTINUE_ON_FAILURE)
