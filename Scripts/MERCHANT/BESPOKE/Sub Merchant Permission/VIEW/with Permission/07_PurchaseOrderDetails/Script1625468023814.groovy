...
WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_PaymentMethod'), 0)

WebUI.verifyElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_PaymentMethod'), FailureHandling.CONTINUE_ON_FAILURE)
