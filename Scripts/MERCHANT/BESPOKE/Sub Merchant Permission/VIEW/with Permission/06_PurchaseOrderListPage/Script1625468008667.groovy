...
WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/column_InvoiceNo'), 0)

WebUI.verifyElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/column_InvoiceNo'))
