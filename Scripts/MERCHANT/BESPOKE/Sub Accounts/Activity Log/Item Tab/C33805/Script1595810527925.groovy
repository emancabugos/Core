...
WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/MERCHANT/Sub Account/Pages/tab_Items'), 0)

WebUI.click(findTestObject('BESPOKE DEL 2/MERCHANT/Sub Account/Pages/tab_Items'), FailureHandling.CONTINUE_ON_FAILURE)

def table = WebUI.getText(findTestObject('BESPOKE DEL 2/MERCHANT/Sub Account/Logs/Items/td_userName'))
