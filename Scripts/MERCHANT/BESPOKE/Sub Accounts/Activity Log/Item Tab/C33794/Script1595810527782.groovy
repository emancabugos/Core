...
WebUI.click(findTestObject('MERCHANT/Merchant Sub Account/Activity Log/tab_Items'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/MERCHANT/Sub Account/Pages/Items_header/th_Item Name'), 0)
