...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_YourPassword'), '123456')

WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_ReconfirmPassword'), '1234567')
...
WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/warning_PasswordNotMatch'), 0)

WebUI.verifyElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/warning_PasswordNotMatch'), FailureHandling.CONTINUE_ON_FAILURE)
