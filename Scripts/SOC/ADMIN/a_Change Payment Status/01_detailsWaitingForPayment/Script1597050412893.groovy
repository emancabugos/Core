...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_PaymentStatus'), 'Waiting For Payment', false, 
    0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_PaymentStatus'), 'Waiting for payment')
