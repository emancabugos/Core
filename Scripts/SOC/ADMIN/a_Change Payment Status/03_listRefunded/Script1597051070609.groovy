...
WebUI.selectOptionByIndex(findTestObject('BESPOKE DEL 2/CONSUMER/Review Details Page/dropdown_SelectDeliveryMethod'), 4, 
...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Transaction List and Details/Transaction List Page/value_PaymentStatus'), 
    'Refunded', false, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SOC/Transaction/button_Okay'), 0)

WebUI.click(findTestObject('SOC/Transaction/button_Okay'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_PaymentStatus'), 'Refunded', false, 0)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('BESPOKE DEL 2/MERCHANT/Orders and Details/Orders/PaymentStatus_value'), 
    'Refunded', false, 0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_PaymentStatus'), 'Refunded')
