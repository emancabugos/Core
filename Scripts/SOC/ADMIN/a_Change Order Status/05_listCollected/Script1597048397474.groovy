...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_OrderStatus'), 'Collected', false, 0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_OrderStatus'), 'Collected')
