...
WebUI.selectOptionByLabel(findTestObject('ADMIN/Transaction List and Details/Transaction List Page/value_OrderStatus'), 
    'Created', false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SOC/Transaction/dropdown_OrderStatus'), 'Created', false, 0)
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History Details/textlabel_OrderStatus'), 'Created')
