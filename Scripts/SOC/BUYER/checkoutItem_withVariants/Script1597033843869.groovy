...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Homepage/textfield_Search'), 'Item with Variants')
...
WebUI.selectOptionByLabel(findTestObject('SOC/Item Details/dropdown_VariantsOpt1'), 'White', false)

WebUI.delay(1)

WebUI.selectOptionByLabel(findTestObject('SOC/Item Details/dropdown_VariantsOpt2'), 'Small', false)
