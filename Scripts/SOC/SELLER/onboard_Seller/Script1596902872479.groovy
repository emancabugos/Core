...
WebUI.setText(findTestObject('BESPOKE DEL 2/MERCHANT/Merchant Onboarding/Profile Page/Profile/textbox_DisplayName'), 'soc_seller01')
...
WebUI.comment('Payment - COD')

WebUI.waitForElementVisible(findTestObject('SOC/Onboarding/button_LinkAccountCOD'), 0)

WebUI.click(findTestObject('SOC/Onboarding/button_LinkAccountCOD'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('SOC/Onboarding/button_LinkAccountCustomPayment'), 0)

WebUI.click(findTestObject('SOC/Onboarding/button_LinkAccountCustomPayment'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('SOC/Add Item/menu_YourProducts'), 0)
