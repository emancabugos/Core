...
WebUI.setText(findTestObject('ADMIN/Gmail Page/textfield_password'), GlobalVariable.SOCpasswordGmail)
...
WebUI.setText(findTestObject('ADMIN/Gmail Page/textfield_searchbar'), 'Seller Invite')

WebUI.sendKeys(findTestObject('ADMIN/Gmail Page/textfield_searchbar'), Keys.chord(Keys.ENTER))

WebUI.waitForElementVisible(findTestObject('ADMIN/Gmail Page/link_Seller Invite'), 0)

WebUI.delay(2)

WebUI.click(findTestObject('ADMIN/Gmail Page/link_Seller Invite'), FailureHandling.CONTINUE_ON_FAILURE)
