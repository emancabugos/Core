...
WebUI.waitForElementVisible(findTestObject('SOC/Add Item/toggle_VariantsSOC'), 0)

WebUI.click(findTestObject('SOC/Add Item/toggle_VariantsSOC'), FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Variant Options')

WebUI.waitForElementVisible(findTestObject('SOC/Add Item/variants_Name1'), 0)

WebUI.click(findTestObject('SOC/Add Item/buttn_Delete'))

WebUI.setText(findTestObject('SOC/Add Item/vartians_Opt1'), 'White,Black,')

WebUI.setText(findTestObject('SOC/Add Item/variants_Name2'), 'Size')

WebUI.setText(findTestObject('SOC/Add Item/vartians_Opt2'), 'Small,Medium,')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Sur1'), '5')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Sur2'), '5')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Stock1'), '10')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Stock2'), '10')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Stock3'), '10')

WebUI.setText(findTestObject('SOC/Add Item/textfield_Stock4'), '10')
