...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_NotificationEmail'), 'tester123')

WebUI.verifyElementAttributeValue(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_NotificationEmail'), 
    'value', 'tester123', 0)
