...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_YourPassword'), '!@#$%^&*()_+=-{};\'\\./{}"|<>?')

WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_ReconfirmPassword'), '!@#$%^&*()_+=-{};\'\\./{}"|<>?')
