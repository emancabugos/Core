...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_YourEmailUsername'), 'tester123')

WebUI.verifyElementAttributeValue(findTestObject('BESPOKE DEL 2/CONSUMER/Private Register Page/textfield_YourEmailUsername'), 
    'value', 'tester123', 0)
