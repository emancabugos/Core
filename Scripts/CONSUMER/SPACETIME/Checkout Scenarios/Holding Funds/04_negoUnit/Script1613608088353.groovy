...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), 'Checkout HF - Unit Only')
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), 'Checkout HF - Unit Only')
