...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), 'Service per hour 24/7 01seller')
...
def actualsubtotal = WebUI.getText(findTestObject('SPACETIME/CONSUMER/Review Details Page/textlabelvalue_subtotal'))
