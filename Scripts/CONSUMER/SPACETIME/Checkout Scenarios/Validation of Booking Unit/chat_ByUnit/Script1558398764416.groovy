...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Offer'), '9')
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), 'Custom 15Min Not 24/7')
