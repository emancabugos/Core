...
WebUI.waitForElementVisible(findTestObject('SPACETIME/ARC-7412/Item Details/Page_0613stdiana/a_diana new item 2'), 0)

WebUI.click(findTestObject('SPACETIME/ARC-7412/Item Details/Page_0613stdiana/a_diana new item 2'))
