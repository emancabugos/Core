...
def upcoming2y = upup[0]
def upcomingd = upup[1]
def upcoming1m = upup[2]

int upcomingdint = Integer.parseInt(upcomingd)
upcoming1dcompute = (upcomingdint - 1)
println(upcoming1dcompute)
println(upcoming1m)
println(upcoming2y)
...
def upcoming2y2nd = upup2nd[0]
def upcomingd2nd = upup2nd[1]
def upcoming1m2nd = upup2nd[2]
...
finaldateup = ((((upcoming2y + '/') + upcoming1m) + '/') + upcoming1dcompute)
finaldateup2nd = ((((upcoming2y2nd + '/') + upcoming1m2nd) + '/') +  upcoming1dcompute2nd)
