...
WebUI.verifyElementText(findTestObject('SPACETIME/ARC-7412/Homepage_searchbar/textfield_datesearch'), finaldate & '-' & finaldate, FailureHandling.CONTINUE_ON_FAILURE)
