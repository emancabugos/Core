...
WebUI.verifyElementPresent(findTestObject('SPACETIME/CONSUMER/Purchase History Details/Release Funds/errorMsg_Unable to release funds This order is not paid yet'), 
    0)
