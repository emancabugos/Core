...
'Checkout Duration NEGO'
WebUI.callTestCase(findTestCase('CONSUMER/SPACETIME/Checkout Scenarios/Holding Funds/02_negoDuration'), [:], FailureHandling.CONTINUE_ON_FAILURE)
