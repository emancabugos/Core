...
'Checkout Unit and Duration NEGO'
WebUI.callTestCase(findTestCase('CONSUMER/SPACETIME/Checkout Scenarios/Holding Funds/06_negoUnitDuration'), [:], FailureHandling.CONTINUE_ON_FAILURE)
