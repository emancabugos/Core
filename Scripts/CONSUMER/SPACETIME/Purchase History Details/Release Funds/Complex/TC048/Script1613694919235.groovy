...
'Checkout Unit and Duration SPOT'
WebUI.callTestCase(findTestCase('CONSUMER/SPACETIME/Checkout Scenarios/Holding Funds/05_checkoutUnitDuration'), [:], FailureHandling.CONTINUE_ON_FAILURE)
