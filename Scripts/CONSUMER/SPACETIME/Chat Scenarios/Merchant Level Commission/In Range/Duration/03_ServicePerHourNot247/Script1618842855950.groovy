...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('Custom per 1hr NOT 24/7 D' + ' ') + 
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('Custom per 1hr NOT 24/7 D' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Duration'), '1')

WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Offer'), '200')
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('Custom per 1hr NOT 24/7 D' + ' ') + 
    GlobalVariable.CustomMerchant)
