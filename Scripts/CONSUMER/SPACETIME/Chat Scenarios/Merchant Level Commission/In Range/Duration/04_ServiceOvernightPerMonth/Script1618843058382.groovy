...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('per Night Month D' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('per Night Month D' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Offer'), '300')
