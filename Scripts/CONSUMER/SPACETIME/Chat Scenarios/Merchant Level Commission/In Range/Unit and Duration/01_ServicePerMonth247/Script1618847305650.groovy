...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('per Month 24/7 UD' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('per Month 24/7 UD' + ' ') + GlobalVariable.CustomMerchant)
