...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('Custom per 28night UD' + ' ') + 
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('Custom per 28night UD' + ' ') + GlobalVariable.CustomMerchant)
