...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('per Day 24/7 U' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('per Hour 24/7 D' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Chat Details Page/textfield_Offer'), '100')
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('per Day 24/7 U' + ' ') + GlobalVariable.CustomMerchant)
