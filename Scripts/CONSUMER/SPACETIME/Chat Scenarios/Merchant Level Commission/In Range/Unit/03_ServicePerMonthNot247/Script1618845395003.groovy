...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Keyword'), ('per Month NOT 24/7 U' + ' ') + GlobalVariable.CustomMerchant)
...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Inbox/textfield_Search'), ('per Month NOT 24/7 U' + ' ') + GlobalVariable.CustomMerchant)
