...
WebUI.waitForElementVisible(findTestObject('ADMIN/Private Settings/tab_Consumer'), 0)

WebUI.click(findTestObject('ADMIN/Private Settings/tab_Consumer'))
...
WebUI.waitForElementVisible(findTestObject('ADMIN/User Mgmt/Waiting List/textarea_invitebuyer'), 0)

WebUI.setText(findTestObject('ADMIN/User Mgmt/Waiting List/textarea_invitebuyer'), GlobalVariable.username_invitedbuyer)
...
/*String signin = WebUI.verifyElementVisible(findTestObject('ADMIN/Gmail Page/link_Mag-sign In'))

if (signin == true) {
    WebUI.click(findTestObject('ADMIN/Gmail Page/link_Mag-sign In'))
} else {
    WebUI.delay(3)
}*/
/*WebUI.waitForElementVisible(findTestObject('ADMIN/Gmail Page/link_Mag-sign In'), FailureHandling.OPTIONAL)*/
WebUI.click(findTestObject('ADMIN/Gmail Page/link_Mag-sign In'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Time/Consumer/Private Login Page/button_CreateAccount_Private'))
