...
WebUI.setText(findTestObject('SPACETIME/CONSUMER/Search Function/textfield_Location'), itemName)
...
WebUI.click(findTestObject('SPACETIME/CONSUMER/Item Details Page/button_MerchantStorefront'), FailureHandling.STOP_ON_FAILURE)
