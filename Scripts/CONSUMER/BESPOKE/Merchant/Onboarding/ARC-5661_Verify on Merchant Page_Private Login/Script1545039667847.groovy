...
WebUI.waitForElementVisible(findTestObject('ADMIN/User Mgmt/Waiting List/textarea_email_consumer'), 0)

WebUI.setText(findTestObject('ADMIN/User Mgmt/Waiting List/textarea_email_consumer'), GlobalVariable.username_invitedmerchant)
