...
WebUI.clearText(findTestObject('BESPOKE DEL 2/CONSUMER/Interested User/textfield_YourEmail'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Interested User/textfield_YourEmail'), 'test')
