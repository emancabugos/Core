...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Homepage/textfield_Search'), 'Item_01 18seller')
...
WebUI.selectOptionByValue(findTestObject('BESPOKE DEL 2/CONSUMER/Item Details/dd_qty'), '4', true)
...
WebUI.callTestCase(findTestCase('CONSUMER/BESPOKE/Payment Method/pay_CustomPayment'), [:], FailureHandling.CONTINUE_ON_FAILURE)
