...
'Checkout Item 03 - Admin Delivery - Omise'
...
WebUI.setText(findTestObject('BESPOKE DEL 2/CONSUMER/Homepage/button_Search'), itemName)

WebUI.sendKeys(findTestObject('BESPOKE DEL 2/CONSUMER/Homepage/button_Search'), Keys.chord(Keys.ENTER))
