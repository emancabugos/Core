...
WebUI.setText(findTestObject('ADMIN/New Item List/textbox_search'), 'Item 01')

WebUI.click(findTestObject('ADMIN/New Item List/button_apply'))

WebUI.delay(5)

actualstock = WebUI.getText(findTestObject('ADMIN/New Item List/1stvalue_total stock'))

WebUI.verifyEqual(finalstock, actualstock)
