...
import internal.GlobalVariable as GlobalVariabl
...
WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Payment Page/dropdown_PaymentMethod'), 0)

WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Payment Page/textlabelValue_SubTotal'), '')
