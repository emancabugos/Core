...
WebUI.click(findTestObject('BESPOKE DEL 2/CONSUMER/Payment Page/button_Back'))

WebUI.waitForElementVisible(findTestObject('BESPOKE DEL 2/CONSUMER/Review Details Page/textlabelValue_MinimumLeadTime'), 
    0)
