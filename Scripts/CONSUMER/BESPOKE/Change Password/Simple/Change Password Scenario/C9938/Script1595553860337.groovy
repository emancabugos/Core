...
WebUI.setText(findTestObject('Utilities/Change Password/input_newpassword'), 'Welcome08!')

WebUI.setText(findTestObject('Utilities/Change Password/input_confirmnewpassword'), 'Welcome08!')
