...
WebUI.setText(findTestObject('Utilities/Change Password/input_oldpassword'), 'invalid')
...
WebUI.verifyElementPresent(findTestObject('Utilities/Change Password/invalid_login'), 0)
