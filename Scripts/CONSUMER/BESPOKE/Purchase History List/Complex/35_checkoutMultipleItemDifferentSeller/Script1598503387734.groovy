...
WebUI.callTestCase(findTestCase('CONSUMER/BESPOKE/Purchase History List/Pre Requisite/checkout_multipleItemMultiSeller'), 
...
WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/linktext_invoiceID2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabelvalue_Date2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabelvalue_Time2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_Quantity2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_OrderTotal2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_PaymentMethod2'), 0)

WebUI.verifyElementPresent(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_PaymentStatus2'), 0)

WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/linktext_invoiceID2'), invoiceid)
