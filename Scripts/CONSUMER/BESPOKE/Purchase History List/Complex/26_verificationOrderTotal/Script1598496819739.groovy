...
def Factualtotal = WebUI.getText(findTestObject('BESPOKE DEL 2/CONSUMER/Review Details Page/textabelvalue_FTotal'))
...
WebUI.verifyElementText(findTestObject('BESPOKE DEL 2/CONSUMER/Purchase History List/textlabel_OrderTotal'), Factualtotal)
